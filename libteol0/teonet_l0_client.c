 ...
 * @return
 */
size_t teoLNullPacketCreateEcho(teoLNullEncryptionContext* ctx, void *buf, size_t buf_len,
    ...
    size_t package_len = teoLNullPacketCreate(ctx, buf, buf_len, CMD_L_ECHO,
